...
namespace EFAxeCreditFull
{
    ...
    public partial class rating_agency
    {
        public rating_agency()
        {
            this.rating_type = new HashSet<rating_type>();
        }
    
        public int rating_agency_id { get; set; }
        public string rating_agency_shortname { get; set; }
        public string rating_agency_name { get; set; }
        ...
        public virtual ICollection<rating_type> rating_type { get; set; }
    }
}
