...
namespace EFAxeCreditFull
{
    ...
    public partial class amortization_type
    {
        ...
        public string amortization_type_shortname { get; set; }
        public string amortization_type_type { get; set; }
        public string amortization_type_calcul_mode { get; set; }
